...
describe('Instancing component from provided DOM data attribute', function () {
    ...
    before(function() {
        driver.get('fixture.html');
        return driver.wait(webdriver.until.elementLocated(webdriver.By.css("px-app-nav li")), 10000);
    });

    it('should automatically instance a px-app-nav from the expected DOM', function () {
        return chai.expect(
